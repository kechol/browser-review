...
The CLI listens on loopback. Review comments, page text, URLs, source hints and
optional screenshots may enter the connected agent's context; form-value filtering
is not general-purpose anonymization. Use fictional data when sharing examples.
